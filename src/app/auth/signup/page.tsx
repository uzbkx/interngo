      ...
      <div className="w-full max-w-[400px] rounded-xl border bg-background p-6 shadow-lg shadow-black/5">
        ...
        <div className="flex flex-col items-center gap-2 mb-6">
          ...
          <div className="text-center">
            <h1 className="text-lg font-semibold tracking-tight">{t("createAccount")}</h1>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          {t("haveAccount")}{" "}
          <Link href="/auth/login" className="underline hover:no-underline text-primary font-medium">
            {t("login")}
          </Link>
        </p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-3">
          ...
          and{" "}
          <Link className="underline hover:no-underline" href="/privacy">Privacy Policy</Link>.
        </p>
      </div>
    </div>
  );
